...
export default function SpectrumLedger() {
  ...
  return (
    <OnchainKitProvider chain={chain}>
      <div style={{ maxWidth: 900, margin: "46px auto", fontFamily: "system-ui" }}>
        <h1>SpectrumLedger — Built for Base</h1>
        ...
        <div style={{ display: "flex", gap: 12, flexWrap: "wrap", alignItems: "center" }}>
          ...
          <button onClick={runLedgerRead} style={{ padding: "6px 12px" }}>
            Run Read
          </button>
